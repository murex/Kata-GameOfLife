...
- Create a build directory: Kata-GameOfLife/cpp/build. All build-related files are generated in this directory.
...
- Generate the solution file ***Kata-GameOfLife.sln*** for **Visual Studio 2017** on Windows,
 or the project file ***Kata-GameOfLife.xcodeproj*** for **Xcode** on macOS.
...
Run the test file [GameOfLifeTest.cpp](./test/GameOfLifeTest.cpp)
...
Open Visual Studio Code, choose `Open Folder`, navigate to `Kata-GameOfLife` / `cpp`
